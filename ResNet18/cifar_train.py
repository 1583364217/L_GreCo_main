...
parser.add_argument('--dataset-dir', default=os.path.expanduser('./cifar100'),
                    help='path to training data')

parser.add_argument('--powersgd-rank', type=int, default=4,
...
parser.add_argument('--seed', type=int, default=42,
                    help='random seed')
parser.add_argument('--dist-backend', choices=['qmpi', 'nccl', 'gloo'], default='gloo',
...
parser.add_argument('--method', type=str, default='powerSGD',
